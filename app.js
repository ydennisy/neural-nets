var Unit = function(value, grad){
  ...
  this.value = value;
  // the derivative of circuit output wrt to this Unit, computed in backpass
  this.grad = grad;
};
...
multiplyGate.prototype = {
  forward : function (u0, u1){
    // store pointers to input units u0, u1 and output unit utop
    this.u0 = u0;
    this.u1 = u1;
  ...
  backward : function (){
    // take the gradient in the output unit and chain it with
    // local gradients, which are derived from the multiplyGate
    // before writing them back to those units
